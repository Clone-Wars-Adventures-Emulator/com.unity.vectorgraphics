...
namespace Unity.VectorGraphics.Editor
{
    ...
    public class SVGImporter : ScriptedImporter, ISpriteEditorDataProvider
    {
        ...
        private void GenerateUGUISpriteAsset(AssetImportContext ctx, Sprite sprite, string name, SVGParser.SceneInfo scene)
        {
            ...
            // in an SVG exported by JPEXS, this is the <g> tag that has the main transform applied
            var m2d = scene.Scene.Root.Children[0].Children[0].Transform;
            rt.pivot = new Vector2(m2d.m02 / scene.SceneViewport.width, 1 - (m2d.m12 / scene.SceneViewport.height));
